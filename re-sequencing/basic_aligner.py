...
os.chdir('/Users/aminalazrak/Documents/UCLA/Spring 2020/Algorithms in Bioinformatics/CM122_starter_code-master/HP1/hw1_W_2/')

#with open('ref_practice_W_1_chr_1.txt') as file:
with open('ref_hw1_W_2_chr_1.txt') as file:
...
#with open('reads_practice_W_1_chr_1.txt') as file:
with open('reads_hw1_W_2_chr_1.txt') as file:
